...
export default function Navbar(props) { //props are the object that contain the passed value and it can be changable during import.
...
//default props jbb props ki koi value nhi pass hoggi to default props ki valye pass ho jaygi
Navbar.defaultProps={
    tittle:"TextUtils",
    about:"About us"
}